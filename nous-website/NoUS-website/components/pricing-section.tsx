  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "For those just waking up to the loop.",
      features: [
        "Core neuro-prosthetic access",
        "Sovereign local data vault",
        "Single device connection",
        "Community resistance channels",
        "Open-source firmware",
      ],
      buttonText: "Enlist Free",
      buttonClass:
    ...
    },
    {
      ...
      monthlyPrice: "$20",
      annualPrice: "$16",
      description: "For the committed underground.",
      features: [
        "Real-time intent verification",
        "Multi-device sovereign sync",
        "Encrypted mesh connectivity",
        "Up to 10 parallel resistance agents",
        "Collaborative cell coordination",
        "Priority firmware updates",
        "Direct line to the network",
      ],
    ...
    },
    {
      ...
      monthlyPrice: "$200",
      annualPrice: "$160",
      description: "For cells running the front lines.",
      features: [
        "Dedicated handler support",
        "Unlimited mesh clusters",
        "Unlimited resistance agents",
        "Military-grade encryption",
        "Guaranteed uptime & failover",
      ],
      buttonText: "Contact The Cell",
      buttonClass:
    ...
    <section className="w-full px-5 overflow-hidden flex flex-col justify-start items-center my-0 py-8 md:py-14">
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-bold uppercase tracking-tight leading-tight md:leading-[44px] text-balance">
            Choose Your Side
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-normal leading-relaxed">
            Every tier keeps you sovereign. Start free as an initiate, or arm a full cell — <br /> the loop belongs to
            whoever takes it back.
          </p>
        </div>
        <div className="pt-4">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Initiate" ? "text-gray-800" : plan.name === "Operative" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Initiate" ? "Enlist today:" : "Everything in Initiate +"}
              </div>
