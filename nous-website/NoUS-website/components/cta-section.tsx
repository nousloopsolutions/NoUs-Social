    ...
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-4xl md:text-5xl lg:text-[68px] font-bold uppercase tracking-tight leading-tight md:leading-tight lg:leading-[76px] break-words max-w-[560px] text-balance">
            Take Back The Loop
          </h2>
          <p className="text-muted-foreground text-sm md:text-base font-normal leading-relaxed break-words max-w-2xl text-pretty">
            Join an underground network reclaiming the space between intent and action. Sovereign, mathematical, human —
            the way it should have been all along.
          </p>
        </div>
        <Link href="#pricing-section">
          <Button
            className="px-[30px] py-2 bg-primary text-primary-foreground text-base font-bold uppercase tracking-wide leading-6 rounded box-glow hover:bg-primary-dark transition-all duration-200"
            size="lg"
          >
            Join The Loop
          </Button>
