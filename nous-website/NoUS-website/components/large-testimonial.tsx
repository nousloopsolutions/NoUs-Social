        ...
        <div className="self-stretch px-4 py-12 md:px-6 md:py-16 lg:py-28 flex flex-col justify-start items-start gap-2">
          <div className="self-stretch flex justify-between items-center">
            <div className="flex-1 px-4 py-8 md:px-12 lg:px-20 md:py-8 lg:py-10 overflow-hidden rounded-lg flex flex-col justify-center items-center gap-6 md:gap-8 lg:gap-11">
              <div className="w-full max-w-[1024px] text-center text-foreground leading-7 md:leading-10 lg:leading-[64px] font-medium text-lg md:text-3xl lg:text-6xl text-balance">
                {
                  "Nousloop gave me back the distance between what I feel and what I do. For the first time in years, the loop is mine."
                }
              </div>
              <div className="flex justify-start items-center gap-5">
                ...
                <div className="flex flex-col justify-start items-start">
                  <div className="text-foreground text-base font-medium leading-6">Anonymous Node</div>
                  <div className="text-muted-foreground text-sm font-normal leading-6 font-mono uppercase tracking-wider">{"Early Loop Member"}</div>
                </div>
              </div>
            </div>
          </div>
